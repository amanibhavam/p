...
class DataAwsSsoadminInstances(
    ...
    jsii_type="aws.ssoadmin.DataAwsSsoadminInstances",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.DataAwsSsoadminInstancesConfig",
...
class DataAwsSsoadminPermissionSet(
    cdktf.TerraformDataSource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ssoadmin.DataAwsSsoadminPermissionSet",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.DataAwsSsoadminPermissionSetConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class SsoadminAccountAssignment(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ssoadmin.SsoadminAccountAssignment",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.SsoadminAccountAssignmentConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class SsoadminManagedPolicyAttachment(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ssoadmin.SsoadminManagedPolicyAttachment",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.SsoadminManagedPolicyAttachmentConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class SsoadminPermissionSet(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ssoadmin.SsoadminPermissionSet",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.SsoadminPermissionSetConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class SsoadminPermissionSetInlinePolicy(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ssoadmin.SsoadminPermissionSetInlinePolicy",
):
...
@jsii.data_type(
    jsii_type="aws.ssoadmin.SsoadminPermissionSetInlinePolicyConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
