...
class LicensemanagerAssociation(
    ...
    jsii_type="aws.licensemanager.LicensemanagerAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.licensemanager.LicensemanagerAssociationConfig",
...
class LicensemanagerLicenseConfiguration(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.licensemanager.LicensemanagerLicenseConfiguration",
):
...
@jsii.data_type(
    jsii_type="aws.licensemanager.LicensemanagerLicenseConfigurationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
