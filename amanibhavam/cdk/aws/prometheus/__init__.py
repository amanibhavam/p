...
class PrometheusAlertManagerDefinition(
    ...
    jsii_type="aws.prometheus.PrometheusAlertManagerDefinition",
):
...
@jsii.data_type(
    jsii_type="aws.prometheus.PrometheusAlertManagerDefinitionConfig",
...
class PrometheusRuleGroupNamespace(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.prometheus.PrometheusRuleGroupNamespace",
):
...
@jsii.data_type(
    jsii_type="aws.prometheus.PrometheusRuleGroupNamespaceConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class PrometheusWorkspace(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.prometheus.PrometheusWorkspace",
):
...
@jsii.data_type(
    jsii_type="aws.prometheus.PrometheusWorkspaceConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
