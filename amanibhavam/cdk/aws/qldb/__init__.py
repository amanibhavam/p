...
class DataAwsQldbLedger(
    ...
    jsii_type="aws.qldb.DataAwsQldbLedger",
):
...
@jsii.data_type(
    jsii_type="aws.qldb.DataAwsQldbLedgerConfig",
...
@jsii.data_type(
    jsii_type="aws.qldb.QldbLedgerConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.qldb.QldbStreamConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.qldb.QldbStreamKinesisConfiguration",
    jsii_struct_bases=[],
    name_mapping={
...
class QldbStreamKinesisConfigurationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.qldb.QldbStreamKinesisConfigurationOutputReference",
):
    def __init__(
        self,
