...
class DataAwsServerlessapplicationrepositoryApplication(
    ...
    jsii_type="aws.serverlessapplicationrepository.DataAwsServerlessapplicationrepositoryApplication",
):
...
@jsii.data_type(
    jsii_type="aws.serverlessapplicationrepository.DataAwsServerlessapplicationrepositoryApplicationConfig",
...
class ServerlessapplicationrepositoryCloudformationStack(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStack",
):
...
@jsii.data_type(
    jsii_type="aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStackConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStackTimeouts",
    jsii_struct_bases=[],
...
class ServerlessapplicationrepositoryCloudformationStackTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStackTimeoutsOutputReference",
):
    def __init__(
        self,
