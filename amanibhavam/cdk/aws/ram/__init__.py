...
class DataAwsRamResourceShare(
    ...
    jsii_type="aws.ram.DataAwsRamResourceShare",
):
...
@jsii.data_type(
    jsii_type="aws.ram.DataAwsRamResourceShareConfig",
...
@jsii.data_type(
    jsii_type="aws.ram.DataAwsRamResourceShareFilter",
    jsii_struct_bases=[],
...
class RamPrincipalAssociation(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamPrincipalAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.ram.RamPrincipalAssociationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class RamResourceAssociation(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamResourceAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.ram.RamResourceAssociationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class RamResourceShare(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamResourceShare",
):
...
class RamResourceShareAccepter(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamResourceShareAccepter",
):
...
@jsii.data_type(
    jsii_type="aws.ram.RamResourceShareAccepterConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.ram.RamResourceShareAccepterTimeouts",
    jsii_struct_bases=[],
...
class RamResourceShareAccepterTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamResourceShareAccepterTimeoutsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="aws.ram.RamResourceShareConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.ram.RamResourceShareTimeouts",
    jsii_struct_bases=[],
    name_mapping={"create": "create", "delete": "delete"},
)
...
class RamResourceShareTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.ram.RamResourceShareTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
