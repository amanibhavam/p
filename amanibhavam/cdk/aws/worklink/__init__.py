...
class WorklinkFleet(
    ...
    jsii_type="aws.worklink.WorklinkFleet",
):
...
@jsii.data_type(
    jsii_type="aws.worklink.WorklinkFleetConfig",
...
@jsii.data_type(
    jsii_type="aws.worklink.WorklinkFleetIdentityProvider",
    jsii_struct_bases=[],
...
class WorklinkFleetIdentityProviderOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.worklink.WorklinkFleetIdentityProviderOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="aws.worklink.WorklinkFleetNetwork",
    jsii_struct_bases=[],
    name_mapping={
...
class WorklinkFleetNetworkOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.worklink.WorklinkFleetNetworkOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class WorklinkWebsiteCertificateAuthorityAssociation(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.worklink.WorklinkWebsiteCertificateAuthorityAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.worklink.WorklinkWebsiteCertificateAuthorityAssociationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
