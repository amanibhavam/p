...
class CodepipelineWebhook(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.codepipeline.CodepipelineWebhook",
):
...
@jsii.data_type(
    jsii_type="aws.codepipeline.CodepipelineWebhookAuthenticationConfiguration",
    jsii_struct_bases=[],
...
class CodepipelineWebhookAuthenticationConfigurationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.codepipeline.CodepipelineWebhookAuthenticationConfigurationOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="aws.codepipeline.CodepipelineWebhookConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.codepipeline.CodepipelineWebhookFilter",
    jsii_struct_bases=[],
