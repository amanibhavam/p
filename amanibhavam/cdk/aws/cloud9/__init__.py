...
class Cloud9EnvironmentEc2(
    ...
    jsii_type="aws.cloud9.Cloud9EnvironmentEc2",
):
...
@jsii.data_type(
    jsii_type="aws.cloud9.Cloud9EnvironmentEc2Config",
...
class Cloud9EnvironmentMembership(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloud9.Cloud9EnvironmentMembership",
):
...
@jsii.data_type(
    jsii_type="aws.cloud9.Cloud9EnvironmentMembershipConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
