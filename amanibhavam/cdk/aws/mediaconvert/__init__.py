...
class MediaConvertQueue(
    ...
    jsii_type="aws.mediaconvert.MediaConvertQueue",
):
...
@jsii.data_type(
    jsii_type="aws.mediaconvert.MediaConvertQueueConfig",
...
@jsii.data_type(
    jsii_type="aws.mediaconvert.MediaConvertQueueReservationPlanSettings",
    jsii_struct_bases=[],
    name_mapping={
        "commitment": "commitment",
...
class MediaConvertQueueReservationPlanSettingsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.mediaconvert.MediaConvertQueueReservationPlanSettingsOutputReference",
):
    def __init__(
        self,
