...
class XrayEncryptionConfig(
    ...
    jsii_type="aws.xray.XrayEncryptionConfig",
):
...
@jsii.data_type(
    jsii_type="aws.xray.XrayEncryptionConfigConfig",
...
@jsii.data_type(
    jsii_type="aws.xray.XrayGroupConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.xray.XrayGroupInsightsConfiguration",
    jsii_struct_bases=[],
    name_mapping={
...
class XrayGroupInsightsConfigurationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.xray.XrayGroupInsightsConfigurationOutputReference",
):
    def __init__(
        self,
...
class XraySamplingRule(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.xray.XraySamplingRule",
):
...
@jsii.data_type(
    jsii_type="aws.xray.XraySamplingRuleConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
