...
class CloudhsmV2Cluster(
    ...
    jsii_type="aws.cloudhsm.CloudhsmV2Cluster",
):
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterClusterCertificates",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class CloudhsmV2ClusterClusterCertificatesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterClusterCertificatesList",
):
    def __init__(
        self,
...
class CloudhsmV2ClusterClusterCertificatesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterClusterCertificatesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterConfig",
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterTimeouts",
    jsii_struct_bases=[],
...
class CloudhsmV2ClusterTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.CloudhsmV2ClusterTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class CloudhsmV2Hsm(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.CloudhsmV2Hsm",
):
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.CloudhsmV2HsmConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.CloudhsmV2HsmTimeouts",
    jsii_struct_bases=[],
...
class CloudhsmV2HsmTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.CloudhsmV2HsmTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class DataAwsCloudhsmV2Cluster(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.DataAwsCloudhsmV2Cluster",
):
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificates",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataAwsCloudhsmV2ClusterClusterCertificatesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificatesList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="aws.cloudhsm.DataAwsCloudhsmV2ClusterConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
