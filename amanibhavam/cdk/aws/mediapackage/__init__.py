...
class MediaPackageChannel(
    ...
    jsii_type="aws.mediapackage.MediaPackageChannel",
):
...
@jsii.data_type(
    jsii_type="aws.mediapackage.MediaPackageChannelConfig",
...
@jsii.data_type(
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngest",
    jsii_struct_bases=[],
    name_mapping={},
)
...
@jsii.data_type(
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngestIngestEndpoints",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class MediaPackageChannelHlsIngestIngestEndpointsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngestIngestEndpointsList",
):
    def __init__(
        self,
...
class MediaPackageChannelHlsIngestIngestEndpointsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngestIngestEndpointsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class MediaPackageChannelHlsIngestList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngestList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class MediaPackageChannelHlsIngestOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.mediapackage.MediaPackageChannelHlsIngestOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
