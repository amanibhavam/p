...
class LightsailDomain(
    ...
    jsii_type="aws.lightsail.LightsailDomain",
):
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailDomainConfig",
...
class LightsailInstance(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.lightsail.LightsailInstance",
):
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailInstanceConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class LightsailInstancePublicPorts(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.lightsail.LightsailInstancePublicPorts",
):
    ...
    def port_info(
        ...
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["LightsailInstancePublicPortsPortInfo"]], jsii.get(self, "portInfo"))

    @port_info.setter
    def port_info(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["LightsailInstancePublicPortsPortInfo"]],
    ) -> None:
        jsii.set(self, "portInfo", value)


@jsii.data_type(
    jsii_type="aws.lightsail.LightsailInstancePublicPortsConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailInstancePublicPortsPortInfo",
    jsii_struct_bases=[],
    name_mapping={
        "from_port": "fromPort",
        "protocol": "protocol",
...
class LightsailKeyPair(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.lightsail.LightsailKeyPair",
):
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailKeyPairConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class LightsailStaticIp(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.lightsail.LightsailStaticIp",
):
...
class LightsailStaticIpAttachment(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.lightsail.LightsailStaticIpAttachment",
):
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailStaticIpAttachmentConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.lightsail.LightsailStaticIpConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
