...
class CloudtrailEventDataStore(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudtrail.CloudtrailEventDataStore",
):
...
@jsii.data_type(
    jsii_type="aws.cloudtrail.CloudtrailEventDataStoreAdvancedEventSelector",
    jsii_struct_bases=[],
    name_mapping={"field_selector": "fieldSelector", "name": "name"},
)
...
@jsii.data_type(
    jsii_type="aws.cloudtrail.CloudtrailEventDataStoreAdvancedEventSelectorFieldSelector",
    jsii_struct_bases=[],
    name_mapping={
        "ends_with": "endsWith",
        "equal_to": "equalTo",
...
@jsii.data_type(
    jsii_type="aws.cloudtrail.CloudtrailEventDataStoreConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.cloudtrail.CloudtrailEventDataStoreTimeouts",
    jsii_struct_bases=[],
...
class CloudtrailEventDataStoreTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudtrail.CloudtrailEventDataStoreTimeoutsOutputReference",
):
    def __init__(
        self,
...
class DataAwsCloudtrailServiceAccount(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cloudtrail.DataAwsCloudtrailServiceAccount",
):
...
@jsii.data_type(
    jsii_type="aws.cloudtrail.DataAwsCloudtrailServiceAccountConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
