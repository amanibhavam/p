...
class FmsAdminAccount(
    ...
    jsii_type="aws.fms.FmsAdminAccount",
):
...
@jsii.data_type(
    jsii_type="aws.fms.FmsAdminAccountConfig",
...
@jsii.data_type(
    jsii_type="aws.fms.FmsPolicyConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
@jsii.data_type(
    jsii_type="aws.fms.FmsPolicyExcludeMap",
    jsii_struct_bases=[],
...
class FmsPolicyExcludeMapOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.fms.FmsPolicyExcludeMapOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="aws.fms.FmsPolicyIncludeMap",
    jsii_struct_bases=[],
    name_mapping={"account": "account", "orgunit": "orgunit"},
)
...
class FmsPolicyIncludeMapOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.fms.FmsPolicyIncludeMapOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="aws.fms.FmsPolicySecurityServicePolicyData",
    jsii_struct_bases=[],
...
class FmsPolicySecurityServicePolicyDataOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.fms.FmsPolicySecurityServicePolicyDataOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
