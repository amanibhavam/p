...
class SchemasDiscoverer(
    ...
    jsii_type="aws.eventbridgeschemas.SchemasDiscoverer",
):
...
@jsii.data_type(
    jsii_type="aws.eventbridgeschemas.SchemasDiscovererConfig",
...
class SchemasRegistry(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.eventbridgeschemas.SchemasRegistry",
):
...
@jsii.data_type(
    jsii_type="aws.eventbridgeschemas.SchemasRegistryConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class SchemasSchema(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.eventbridgeschemas.SchemasSchema",
):
...
@jsii.data_type(
    jsii_type="aws.eventbridgeschemas.SchemasSchemaConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
