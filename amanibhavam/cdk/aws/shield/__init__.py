...
class ShieldProtection(
    ...
    jsii_type="aws.shield.ShieldProtection",
):
...
@jsii.data_type(
    jsii_type="aws.shield.ShieldProtectionConfig",
...
class ShieldProtectionGroup(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.shield.ShieldProtectionGroup",
):
...
@jsii.data_type(
    jsii_type="aws.shield.ShieldProtectionGroupConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class ShieldProtectionHealthCheckAssociation(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.shield.ShieldProtectionHealthCheckAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.shield.ShieldProtectionHealthCheckAssociationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
