...
class MacieMemberAccountAssociation(
    ...
    jsii_type="aws.macie.MacieMemberAccountAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.macie.MacieMemberAccountAssociationConfig",
...
class MacieS3BucketAssociation(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.macie.MacieS3BucketAssociation",
):
...
@jsii.data_type(
    jsii_type="aws.macie.MacieS3BucketAssociationClassificationType",
    jsii_struct_bases=[],
...
class MacieS3BucketAssociationClassificationTypeOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.macie.MacieS3BucketAssociationClassificationTypeOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="aws.macie.MacieS3BucketAssociationConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
