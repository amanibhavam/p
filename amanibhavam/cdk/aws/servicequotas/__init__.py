...
class DataAwsServicequotasService(
    ...
    jsii_type="aws.servicequotas.DataAwsServicequotasService",
):
...
@jsii.data_type(
    jsii_type="aws.servicequotas.DataAwsServicequotasServiceConfig",
...
class DataAwsServicequotasServiceQuota(
    cdktf.TerraformDataSource,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.servicequotas.DataAwsServicequotasServiceQuota",
):
...
@jsii.data_type(
    jsii_type="aws.servicequotas.DataAwsServicequotasServiceQuotaConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class ServicequotasServiceQuota(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.servicequotas.ServicequotasServiceQuota",
):
...
@jsii.data_type(
    jsii_type="aws.servicequotas.ServicequotasServiceQuotaConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
