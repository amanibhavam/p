...
class CurReportDefinition(
    ...
    jsii_type="aws.cur.CurReportDefinition",
):
...
@jsii.data_type(
    jsii_type="aws.cur.CurReportDefinitionConfig",
...
class DataAwsCurReportDefinition(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="aws.cur.DataAwsCurReportDefinition",
):
...
@jsii.data_type(
    jsii_type="aws.cur.DataAwsCurReportDefinitionConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
